...
Linf_temp_function <- function(k_baseline, Linf, 
    ...
    linf_temperate_sensitivity){

    ph_0 <- log10(k_baseline*Linf^2)
    ph_T <- ph_0 + linf_temperate_sensitivity*temperature_deviation
...
# Calculate new growth parameters
    ...
    Linf_new_clim <- Linf_temp_function(k, Linf, k_new_clim, tempr_dev[i], dec_gr)
