...
tempr <- seq(22.52, 31.5, by = 0.1) # temperature range (Dovlo (2016). Seasonal variation in temperature in the Gulf of Guinea; Idike and Lupo (2024). Analysis of sea surface temperature patterns, vari...(29.34))
tempr_min_dev <- -6.5 # minimum temperature deviation from optimal temperature    
tempr_max_dev <- 5.5 # maximum temperature deviation from optimal temperature   
